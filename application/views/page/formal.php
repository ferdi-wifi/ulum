<?php
$formal= $cetak['lembaga_pendidikan'];
   ...
   if ($formal=="MA Raudlatul Ulum") {
      $logo='formal/ma.png';
   }elseif($formal=="MI Raudlatul Ulum"){
    $logo='formal/mi.png';
   }elseif($formal=="MTS Raudlatul Ulum"){
    $logo='formal/mts.jpg';
   }else{
    $logo="";
    }
   ...
   $pdf->Output('Bukti Register '.$formal.'.pdf', 'I');
?>
