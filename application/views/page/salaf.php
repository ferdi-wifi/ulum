...
$salaf= $cetak['status_pendidikan'];
   ...
   if ($salaf=="Pendidikan Diniyah Formal Raudlatul Ulum Tingkat Wustho") {
            $logo='salaf/wustho.png';
    }else if($salaf=="Madrasah I'dadiyah Raudlatul Ulum"){
            $logo='salaf/idadi.png';
    }else if($salaf=="Pendidikan Diniyah Formal Raudlatul Ulum Tingkat Ulya"){
        $logo='salaf/ulya.png';
    }else if($salaf=="Ma'had Aly Raudlatul Ulum"){
        $logo='salaf/mahad.png';
    }else{
        $logo="";
  }
   $html='<table>
            <tr>
                <td colspan="3">
                <img src="'.base_url('assets/img/'.$logo).'">
                </td>
            </tr>';
   ...
   $pdf->Output('Bukti Register '.$salaf.'.pdf', 'I');
?>
