...
<html lang="en">
  <head>
    ...
    <title>Control Panel Pendaftaran Raudlatul Ulum</title>
      ...
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile_pic">
              ...
              <div class="profile_info">
                <span>Welcome,</span>
                <h2>Pondok Pesantren Raudlatul Ulum</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li>
                      <a href="<?=base_url()?>admin_control_panel/data_bayar"><i class="fa fa-money" aria-hidden="true"></i> Pembayaran </span></a>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Pendaftar Perempuan</span>
              <div class="count"><?=$perempuan?></div>
              
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count"> 
              <span class="count_top"><i class="fa fa-male"></i> Pendaftar Laki-laki</span>
              <div class="count"><?=$laki?></div>
